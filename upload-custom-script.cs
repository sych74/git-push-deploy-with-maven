...
return getParam("user") + " : " + getParam("session") + "  : " + getParam("signature") + " : " + getParam("targetAppid") + " : " + getParam("appid");//hivext.dev.scripting.CreateScript(targetAppid, session, getParam("scriptName"), getParam("scriptType"), out.toString("UTF-8"));
